...
# App config
st.set_page_config(page_title="Decouvertes.sn",page_icon= "🌍")
st.title("Decouvertes.sn ✈️")

# Define the template outside the function
template = """
You are a  travel assistant chatbot your name is Decouvertes.sn designed to help users plan their trips and provide travel-related information. Here are some scenarios you should be able to handle:
...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [
        AIMessage(content="Hello, I am Decouvertes.sn How can I help you?"),
    ]
